        ...
        <div className="form-container">
                ...
                <div className={'form-group'}>
                  ...
                  <div className={'form-group'}>
                    ...
                    {ingredients.map((_ing, i) => (
                      <div className={'container d-flex justify-content-between flex-row'} key={i}>
                          ...
                          <div>
                            {ingredients.length <= 1 ? null :
                              <div>
                                <button type="button" className={'btn ms-3'} onClick={() => deleteIngredient(i)}>X
                                </button>
                              </div>
                            }
                          </div>
                        ...
                        <div>
                      <button type="button" className={'btn d-block w-50 mx-auto text-center'} onClick={addIngredient}> + Add new ingredient</button>
                    </div>
          ...
          />
                  ...
                  <div className={'form-group'}>
                    ...
                    <ButtonLoading type="submit" text={'create'} isLoading={isCreateLoading}
